...
(function( $ ) {
	...
	var methods = {
		init: function (options) {
			this._defaults = {
                apiToken: 'xoxp-3771250924-3771250926-5040032653-b98d30',		//#Slack token
	            channelId: 'C070FDSRZ',		//#Slack channel ID
	            user: 'Black Men In Tech',			//name of the user
	            //userLink: '', 		//link to the user in the application - shown in #Slack
	            userImg: 'http://askablackperson.com/img/user-icon-small.png',		//image of the user
	            //userId: '',			//id of the user in the application
	            sysImg: 'http://askablackperson.com/img/aabp.png',			//image to show when the support team replies
	            sysUser: 'Black Men In Tech',
	            queryInterval: 3000,
	            chatBoxHeader: "Send Product Feedback?",
	            slackColor: "#333",
	            messageFetchCount: 100,
	            botUser: 'Black Men In Tech',		//username to post to #Slack
	            sendOnEnter: true,
	            disableIfAway: false,
			...
			html += '<textarea class="form-control slack-new-message" type="text" placeholder="Send Product Feedback"></textarea>';
